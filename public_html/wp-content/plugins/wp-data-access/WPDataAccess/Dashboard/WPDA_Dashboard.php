...
class WPDA_Dashboard
{
    ...
    protected function dashboard_default()
    {
        ...
        ?>?page=wpda_designer" title="Create database tables and indexes">
						...
						<div class="subject">Data(base) Administration</div>
					</div>
        ...
        ?>?page=wpda_templates" title="Customize forms using templates">
						...
						<div class="subject">Data Entry</div>
					</div>
        ...
        ?>" title="Online help and documentation">
							...
							<?php 
        ?>
							<a class="wpda-dashboard-item wpda_tooltip_icons" target="_blank" href="https://wpdataaccess.com/docs/getting-started/whats-new/" title="What's new?">
    ...
    protected function dashboard_mobile()
    {
        ...
        echo  admin_url( 'admin.php' ) ;
        // phpcs:ignore WordPress.Security.EscapeOutput
        ?>?page=wpda_query_builder"><i class="fas fa-tools"></i> SQL</a></li>
    ...
    protected function toolbar_wpda()
    {
        ...
        ?>&page_action=wpda_global_search"
						...
						<div>
							<a href="javascript:jQuery('#upload_file_container_multi').show()"
							   class="wpda-dashboard-item wpda_tooltip"
        ...
        ?>&page_action=wpda_import_csv"
						...
						<div>
							<a href="javascript:jQuery('#wpda_db_container').show(); jQuery('#local_database').focus();"
							   class="wpda-dashboard-item wpda_tooltip"
				...
				<div class="wpda-nowrap">
					<div>
						<div>
							...
							<a href="javascript:jQuery('#upload_file_container').show()"
							   class="wpda-dashboard-item wpda_tooltip"
        ...
        ?>
			<div id="wpda-dashboard-toolbar" class="wpda-dashboard-toolbar" style="display:none">
				<div class="wpda-nowrap">
					<div>
						<div>
							<a href="javascript:jQuery('#no_repository_buttons').hide(); jQuery('#add_table_to_repository').show()"
							   class="wpda-dashboard-item wpda_tooltip"
        ...
        switch ( $tool ) {
            case 'csv':
                $promotions = array( array(
                    'Use the connection wizards for fully automated CSV synchronization.' => array( 'https://wpdataaccess.com/docs/remote-data-files/csv-files/', 'fa-lightbulb' ),
                ) );
                break;
            case 'publisher':
                $promotions = array(
