    ...
    private function settings_tab_rest_api_tab( $tab, $rest_api_settings )
    {
        ...
        if ( 'select' === $tab ) {
            ?>
								<a href="javascript:void(0)"
								   id="wpda_<?php 
            echo  esc_attr( $this->rownum ) ;
            ?>_rest_api_select_http_get_test"
								   title="Test endpoint using http get"
								   class="wpda_tooltip"
        ...
        if ( 'select' === $tab ) {
            ?>
								<a href="javascript:void(0)"
								   id="wpda_<?php 
            echo  esc_attr( $this->rownum ) ;
            ?>_rest_api_select_http_post_test"
								   title="Test endpoint using http post"
								   class="wpda_tooltip"
								   style="padding-left: 5px"
								>
									<span class="dashicons dashicons-external" style="vertical-align: sub"></span>
        ...
        if ( 'select' === $tab ) {
            ...
            ?>"
							...
							<?php 
            echo  '<br/>' ;
            $select_url = esc_url( get_rest_url( null, "wpda/table/datatable" ) );
            echo  $select_url ;
            ?>
							<a href="javascript:void(0)"
							   id="wpda_<?php 
